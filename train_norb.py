...
def parse_args():
    ...
    # Using batch size of 500 for small NORB lead to exceptions handling the data
    ...
    parser.add_argument('--dataset', type=str, default='NORB_small',
                        help='Name of dataset to use.')
    parser.add_argument('--data_dir', type=str,
                        help='Path to directory containing train and test image folders, as '
                        'generated by the generate_norb_small script. i.e- '
...
if __name__ == '__main__':
    ...
    if args.dataset == 'NORB_small':
        from norb_small_data import NORB
        spatial_width = 32
        test_dir = os.path.join(args.data_dir,'norb_small_2D_test_image_data')
        train_dir = os.path.join(args.data_dir,'aug_norb_small_2D_train_image_data')
        dataset_train = NORB(['train'], width=spatial_width, datadir=train_dir)
        dataset_test = NORB(['test'], width=spatial_width, datadir=test_dir)
        n_colors = 3
    else:
    ...
    batches_per_epoch = dataset_train.num_examples / args.batch_size
