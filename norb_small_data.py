...
class NORB(AbstractDataStream):
    """
    A fuel DataStream for small NORRB data
    from fuel:
    ...
    def __init__(self, partition_label='train', datadir='/path/to/dataset', seed=12345, fraction=0.9, width=32, **kwargs):
        ...
        import glob
        print "getting norb images"
        image_files = glob.glob(datadir + "/*.png")
    ...
    def load_image(self, idx):
        ...
        return imagenp.astype(theano.config.floatX) / 255.
